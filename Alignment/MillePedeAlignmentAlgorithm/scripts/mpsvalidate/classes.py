...
#    boundaries_bStruct = [61, 17541, 37021, 121061, 144401, 284201, 700000, 1000000]
    ...
    # check if label is in the range of the structlabels specified by
    # bStructNumber
