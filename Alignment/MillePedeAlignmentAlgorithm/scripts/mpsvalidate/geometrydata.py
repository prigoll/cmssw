...
data = {-1: GeometryData("notfound", 0, [], []),
        ...
        11: GeometryData("TPEHalfDisk", 2, [], []),
        12: GeometryData("TPEHalfCylind", 2, [], []),
        13: GeometryData("TPEEndcap", 2, [], []),
        14: GeometryData("TIBModule", 3, [], []),
        15: GeometryData("TIBString", 3, [], []),
        16: GeometryData("TIBSurface", 3, [], []),
        17: GeometryData("TIBHalfShell", 3, [], []),
        18: GeometryData("TIBLayer", 3, [], []),
        19: GeometryData("TIBHalfBarrel", 3, [], []),
        20: GeometryData("TIBBarrel", 3, [], []),
        21: GeometryData("TIDModule", 4, [], []),
        22: GeometryData("TIDSide", 4, [], []),
        23: GeometryData("TIDRing", 4, [], []),
        24: GeometryData("TIDDisk", 4, [], []),
        25: GeometryData("TIDEndcap", 4, [], []),
        26: GeometryData("TOBModule", 5, [], []),
        27: GeometryData("TOBRod", 5, [], []),
        28: GeometryData("TOBLayer", 5, [], []),
        29: GeometryData("TOBHalfBarrel", 5, [], []),
        ...
        35: GeometryData("TECDisk", 6, [], []),
        36: GeometryData("TECEndcap", 6, [], []),
